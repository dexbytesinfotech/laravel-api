    ...
    public function scopeWithTranslation(Builder $query)
    {
        $query->with([
            'translations' => function (Relation $query) {
                ...
                $locale = $this->locale();
                return $query->whereIn($this->getTranslationsTable().'.'.$this->getLocaleKey(), config('translatable.locales'))->orderByRaw($this->getTranslationsTable().'.'.$this->getLocaleKey()."='$locale'");
            },
        ]);
    }
