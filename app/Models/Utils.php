...
class Utils extends Model
{
   ...
   /**
    ...
    {
        return \Utils::displayPrice($price,config('app_settings.currency.value'),config('app_settings.number_of_decimals.value'),config('app_settings.thousand_separator.value'),config('app_settings.decimal_separator.value'),config('app_settings.currency_position.value'));
    }
