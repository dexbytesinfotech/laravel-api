...
class DriverNotificationController extends BaseController
{
    /**
     * @OA\Get(
     * path="/api/driver/notifications",
     * operationId="driverNotificationList",
     * tags={"Notification"},
     * security={{"passport":{}}},
     * summary="Notification list for driver",
     * security={
     *   {"passport": {}}
     * },
     * description="Notification list for driver",
     *      @OA\Response(
     *          response=201,
    ...
    public function notificationList(Request $request)
    {
        try {
            ...
            ->whereHas('PushDeliveredMessage', function ($query) {
                ...
                $query->whereHas('device', function ($query) {
                    return $query->where('app_name', '=', 'driver');
                });
     ...
     /**
     * @OA\Put(
     *  path="/api/driver/notification/read-display/{message_id}",
     *  operationId="notificationDriverReadDisplay",
     *  tags={"Notification"},
     *  security={{"passport":{}}},
    ...
    /**
     * @OA\Put(
     *  path="/api/driver/notification/read/{messageId}",
    ...
    /**
     * @OA\Put(
     *  path="/api/driver/notification/display",
     *  operationId="markdriverNotificationsDiyplayed",
     *  tags={"Notification"},
     *  security={{"passport":{}}},
    ...
    /**
     * @OA\Delete(
     *  path="/api/driver/notification/delete/{messageId}",
     *  operationId="driverNotificationDelete",
     *  tags={"Notification"},
     *  security={{"passport":{}}},
     ...
     * )
     */
    public function deleteNotification(Request $request, $messageId)
    {
        try {

            $res = PushDeliveredMessage::where('user_id', auth()->user()->id)
                ->where('id', $messageId)->delete();
                PushMessage::where('id', $messageId)->delete();
