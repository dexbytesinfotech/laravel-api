...
class UserNotificationController extends BaseController
{
     ...
     *  tags={"Notification"},
     *  security={{"passport":{}}},
     *  summary="client notification list",
     *  security={
     *      {"passport": {}}
     *  },
     *  description="client notification list",
        ...
        try {
            ...
            ->whereHas('PushDeliveredMessage', function ($query) {
                ...
                $query->whereHas('device', function ($query) {
                    return $query->where('app_name', '=', 'customer');
                });
    ...
    /**
     * @OA\Put(
     *  path="/api/customer/notification/read/{message_id}",
    ...
    /**
     * @OA\Put(
     *  path="/api/customer/notification/read-display/{message_id}",
     *  operationId="notificationReadDisplay",
     *  tags={"Notification"},
     *  security={{"passport":{}}},
    ...
    /**
     * @OA\Put(
     *  path="/api/customer/notification/display",
     *  operationId="markNotificationsDiyplayed",
     *  tags={"Notification"},
     *  security={{"passport":{}}},
    ...
    /**
     * @OA\Delete(
     *  path="/api/customer/notification/delete/{message_id}",
